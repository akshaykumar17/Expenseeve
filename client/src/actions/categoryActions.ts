...
import { GET_CATEGORY, ADD_CATEGORY, SOFTDEL_CATEGORY, DELETE_CATEGORY, LOADING_ITEMS } from './types';
...
export const deleteItem = (id: any) => (dispatch: any) => {
...
export const softdeleteItem = (id: any, category: any, isActive: boolean) => (dispatch: any) => {
